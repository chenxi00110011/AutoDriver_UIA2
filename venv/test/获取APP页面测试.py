# -*- coding: utf-8 -*-
from automation_utils import get_element_data
...
class AppElement:
    def __init__(self, appName):
        self.app_info = yaml_util.YamlUtil(file_name=r'C:\Users\Administrator\PycharmProjects\appAutoTest\venv\data\app_info.yaml').read_yaml()
